...
EXECUTE_PROCESS(COMMAND chown root ${CMAKE_INSTALL_PREFIX}/bin/pdip
                ...
                COMMAND chown root ${CMAKE_INSTALL_PREFIX}/lib/libpdip.so
                COMMAND chgrp root ${CMAKE_INSTALL_PREFIX}/lib/libpdip.so
                COMMAND chown root ${CMAKE_INSTALL_PREFIX}/include/pdip.h
                COMMAND chgrp root ${CMAKE_INSTALL_PREFIX}/include/pdip.h
